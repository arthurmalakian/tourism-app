              ...
              <form @submit.prevent="submit" class="w-full">
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                  ...
                  <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <div class="relative max-w-sm">
                      ...
                      <InputError
                        class="mt-2"
                        :message="form.errors.travelDate"
                      />
                    </div>
                  </div>
                </div>
                ...
                >
                  <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    <div class="relative">
                      <button
                        class="w-full shadow bg-red-600 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"
                        type="button"
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-10">
          ...
          >
            <div
              ...
              style="background-image: url('https://picsum.photos/800/800?random=1')"
